...
- Project: WAR ROOM, a static cinematic cyber-conflict library.
- Version and release: `v1.0.2`, published on GitHub Pages and GitHub Releases.
- Branch: `main`; keep the tree clean and use a `codex/` branch for a scoped change.
- Product scope: 17 dossiers, including five modern dossiers; Intelligence Center; black-and-gold cinematic design.
- Frozen items: episode history, site architecture, visual identity, animation behavior, and release assets unless a new explicit scope authorizes a change.
